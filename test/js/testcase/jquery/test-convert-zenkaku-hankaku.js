...
(function () {
  ...
  describe('CTRL07 特定文字の全角半角変換(英数字＋記号)ができること', function () {
    ...
    // 試験対象サンプルプログラム。
    var sampleFileName = PATH.JQUERY_CONVERT_ZENKAKU_HANKAKU;
    var MSG_JQUERY_CONVERT_ZENKAKU_HANKAKU = 'jquery-convert-zenkaku-hankaku.';
    ...
    // ----------------------- テストケース -----------------------
    it('CTRL0707 001 テキストボックスの値が「ＤＥＦｇｈｉ４５６　（）」になっていることを確認する', function (done) {
      this.timeout(0);
      ...
      m.executeSequentialWithDelay([
        ...
        function () {
          ...
          assert.equal(zenkakuString.value, 'ＤＥＦｇｈｉ４５６　（）', MSG_JQUERY_CONVERT_ZENKAKU_HANKAKU);
        },
        function () {
          done();
        }
    ...
    // ----------------------- テストケース -----------------------
    it('CTRL0707 002 テキストボックスの値が「あいうえ＃＄％＆」になっていることを確認する', function (done) {
      this.timeout(0);
      ...
      m.executeSequentialWithDelay([
        ...
        function () {
          ...
          assert.equal(zenkakuString.value, 'あいうえ＃＄％＆', MSG_JQUERY_CONVERT_ZENKAKU_HANKAKU);
        },
        function () {
          done();
        }
    ...
    // ----------------------- テストケース -----------------------
    it('CTRL0707 003 テキストボックスの値が「DEFghi456 ()」になっていることを確認する', function (done) {
      this.timeout(0);
      ...
      m.executeSequentialWithDelay([
        ...
        function () {
          ...
          assert.equal(hankakuString.value, 'DEFghi456 ()', MSG_JQUERY_CONVERT_ZENKAKU_HANKAKU);
        },
        function () {
          done();
        }
    ...
    // ----------------------- テストケース -----------------------
    it('CTRL0707 004 テキストボックスの値が「あいうえ#$%&」になっていることを確認する', function (done) {
      this.timeout(0);
      ...
      m.executeSequentialWithDelay([
        ...
        function () {
          ...
          // テキストボックスの値が「あいうえ#$%&」になっていることを確認する
          assert.equal(hankakuString.value, 'あいうえ#$%&', MSG_JQUERY_CONVERT_ZENKAKU_HANKAKU);
        },
        function () {
          done();
        }
