...
(function () {
  ...
  describe('CTRL07 特定文字の全角半角変換(カタカナ)ができること', function () {
    ...
    // 試験対象サンプルプログラム。
    var sampleFileName = PATH.JQUERY_CONVERT_ZENKAKU_HANKAKU_FOR_KATAKANA;
    var MSG_JQUERY_CONVERT_ZENKAKU_HANKAKU_FOR_KATAKANA = 'jquery-convert-zenkaku-hankaku-for-katakana.';
    ...
    // ----------------------- テストケース -----------------------
    it('CTRL0708 001 テキストボックスの値が「カキクケコ」になっていることを確認する', function (done) {
      this.timeout(0);
      ...
      m.executeSequentialWithDelay([
        ...
        function () {
          ...
          assert.equal(zenkakuString.value, 'カキクケコ', MSG_JQUERY_CONVERT_ZENKAKU_HANKAKU_FOR_KATAKANA);
        },
        function () {
          done();
        }
    ...
    // ----------------------- テストケース -----------------------
    it('CTRL0708 002 テキストボックスの値が「ｶｷｸｹｺ」になっていることを確認する', function (done) {
      this.timeout(0);
      ...
      m.executeSequentialWithDelay([
        ...
        function () {
          ...
          assert.equal(hankakuString.value, 'ｶｷｸｹｺ', MSG_JQUERY_CONVERT_ZENKAKU_HANKAKU_FOR_KATAKANA);
        },
        function () {
          done();
        }
