      ...
      m.executeSequentialWithDelay([
        function () {
          ...
          /**
            ...
            * カレンダーの要素が存在していないこと
            */
          assert.isNull(calenderView, 'UICP1007 001');
        },
        function () {
        ...
        function () {
          ...
          assert.equal(dateValue, '2014/09/10', 'UICP1007 003');
        },
        function () {
          done();
        }
