...
(function () {
  ...
  function createResultLog() {
    ...
    // 試験サマリ
    var evCommonData = '\"試験日時：' + testExeDateTime + '\"' + csvDelimiter + '\"試験結果：' + 'OK [ ' + topFrameContents.getElementsByTagName('em')[0].innerText + ' ]' + ' NG [ ' + topFrameContents.getElementsByTagName('em')[1].innerText + ' ] \"' + csvDelimiter + '\"userAgent：' + navigator.userAgent + '\"' + csvDelimiter + '\"documentMode：' + documentMode + '\"' + csvDelimiter + '\"innerWidth：' + innerWidth + '\"' + csvDelimiter + '\"outerWidth：' + outerWidth + '\"' + lineFeedCode + lineFeedCode;
    // 試験結果(ヘッダ)
    var evItem = '\"通番\"' + csvDelimiter + '\"試験項目ID\"' + csvDelimiter + '\"試験項目\"' + csvDelimiter + '\"試験時間\"' + csvDelimiter + '\"試験結果\"' + csvDelimiter + '\"NG原因\"' + lineFeedCode;
    // 試験結果
    var evTestData = '';
    // すべてのテスト結果一覧
  ...
  function getNowDateTime() {
    ...
    var minuts = ('00' + today.getMinutes()).slice(-2);
    return year + '/' + month + '/' + date + ' ' + hour + ':' + minuts;
  }
